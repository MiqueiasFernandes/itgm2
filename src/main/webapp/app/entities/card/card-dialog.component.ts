...
export class CardDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.customizeService.query().subscribe(
            (res: Response) => { this.customizes = res.json(); }, (res: Response) => this.onError(res.json()));
    }
    clear() {
    ...
    trackCustomizeById(index: number, item: Customize) {
        return item.id;
    }
}
